...
public class chestList extends AppCompatActivity {
    ...
    public void exersizeList() {
        ...
        exersizeList.addAll(Arrays.asList(chestArray));
        listAdapter = new ArrayAdapter<String>(chestList.this, R.layout.simplerow, exersizeList);
        ...
        ExersizeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent x = new Intent(chestList.this, exersizeTemplate.class);
                startActivity(x);
            }
        });
    }
        ...
        profileBtn.setOnClickListener(
                new OnClickListener() {
                    public void onClick(View v) {
                        Intent i = new Intent(chestList.this, Profile.class);
                        startActivity(i);
                    }
                }
        );
        ...
        bicepsButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View legs) {
                        Intent L = new Intent(chestList.this, HomePage.class);
                        startActivity(L);
                    }
                }
        );
        ...
        absButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View abs) {
                        Intent A = new Intent(chestList.this, absList.class);
                        startActivity(A);
                    }
                }
        );
    ...
    public void onButtonLegsClick(){
        ...
        legsButton.setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View legs) {
                        Intent L = new Intent(chestList.this, legsList.class);
                        startActivity(L);
                    }
                }
        );
        ...
        calfButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View calf) {
                        Intent CA = new Intent(chestList.this, calfList.class);
                        startActivity(CA);
                    }
                }
        );
        ...
        backButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View back) {
                        Intent B = new Intent(chestList.this, backList.class);
                        startActivity(B);
                    }
                }
        );
        ...
        tricepButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View tricep) {
                        Intent T = new Intent(chestList.this, tricepList.class);
                        startActivity(T);
                    }
                }
        );
        ...
        forearmButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View forearm) {
                        Intent F = new Intent(chestList.this, forearmList.class);
                        startActivity(F);
                    }
                }
        );
        ...
        shoulderButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View shoulder) {
                        Intent S = new Intent(chestList.this, shoulderList.class);
                        startActivity(S);
                    }
                }
        );
