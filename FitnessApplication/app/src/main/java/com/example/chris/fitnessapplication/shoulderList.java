...
public class shoulderList extends AppCompatActivity {
    ...
    public void exersizeList() {
        ...
        exersizeList.addAll(Arrays.asList(shoulderArray));
        listAdapter = new ArrayAdapter<String>(shoulderList.this, R.layout.simplerow, exersizeList);
        ...
        ExersizeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent x = new Intent(shoulderList.this, exersizeTemplate.class);
                startActivity(x);
            }
        });
    }
        ...
        profileBtn.setOnClickListener(
                new OnClickListener() {
                    public void onClick(View v) {
                        Intent i = new Intent(shoulderList.this, Profile.class);
                        startActivity(i);
                    }
                }
        );
        ...
        bicepsButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View legs) {
                        Intent L = new Intent(shoulderList.this, HomePage.class);
                        startActivity(L);
                    }
                }
        );
        ...
        absButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View abs) {
                        Intent A = new Intent(shoulderList.this, absList.class);
                        startActivity(A);
                    }
                }
        );
    ...
    public void onButtonLegsClick(){
        ...
        legsButton.setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View legs) {
                        Intent L = new Intent(shoulderList.this, legsList.class);
                        startActivity(L);
                    }
                }
        );
        ...
        chestButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View chest) {
                        Intent CH = new Intent(shoulderList.this, chestList.class);
                        startActivity(CH);
                    }
                }
        );
        ...
        calfButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View calf) {
                        Intent CA = new Intent(shoulderList.this, calfList.class);
                        startActivity(CA);
                    }
                }
        );
        ...
        backButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View back) {
                        Intent B = new Intent(shoulderList.this, backList.class);
                        startActivity(B);
                    }
                }
        );
        ...
        tricepButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View tricep) {
                        Intent T = new Intent(shoulderList.this, tricepList.class);
                        startActivity(T);
                    }
                }
        );
        ...
        forearmButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View forearm) {
                        Intent F = new Intent(shoulderList.this, forearmList.class);
                        startActivity(F);
                    }
                }
        );
