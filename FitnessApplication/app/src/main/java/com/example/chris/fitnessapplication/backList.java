...
public class backList extends AppCompatActivity {
    ...
    public void exersizeList() {
        ...
        exersizeList.addAll(Arrays.asList(backArray));
        listAdapter = new ArrayAdapter<String>(backList.this, R.layout.simplerow, exersizeList);
        ...
        ExersizeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent x = new Intent(backList.this, exersizeTemplate.class);
                startActivity(x);
            }
        });
    }
        ...
        profileBtn.setOnClickListener(
                new OnClickListener() {
                    public void onClick(View v) {
                        Intent i = new Intent(backList.this, Profile.class);
                        startActivity(i);
                    }
                }
        );
        ...
        bicepsButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View legs) {
                        Intent L = new Intent(backList.this, HomePage.class);
                        startActivity(L);
                    }
                }
        );
        ...
        absButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View abs) {
                        Intent A = new Intent(backList.this, absList.class);
                        startActivity(A);
                    }
                }
        );
    ...
    public void onButtonLegsClick(){
        ...
        legsButton.setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View legs) {
                        Intent L = new Intent(backList.this, legsList.class);
                        startActivity(L);
                    }
                }
        );
        ...
        chestButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View chest) {
                        Intent CH = new Intent(backList.this, chestList.class);
                        startActivity(CH);
                    }
                }
        );
        ...
        calfButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View calf) {
                        Intent CA = new Intent(backList.this, calfList.class);
                        startActivity(CA);
                    }
                }
        );
        ...
        tricepButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View tricep) {
                        Intent T = new Intent(backList.this, tricepList.class);
                        startActivity(T);
                    }
                }
        );
        ...
        forearmButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View forearm) {
                        Intent F = new Intent(backList.this, forearmList.class);
                        startActivity(F);
                    }
                }
        );
        ...
        shoulderButton.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View shoulder) {
                        Intent S = new Intent(backList.this, shoulderList.class);
                        startActivity(S);
                    }
                }
        );
