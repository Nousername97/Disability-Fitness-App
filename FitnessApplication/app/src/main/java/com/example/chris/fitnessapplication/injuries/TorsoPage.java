...
public class TorsoPage extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.torsopage);
...
>>>>>>> eeb2a1ffbafecf11a0fc3cd7fa4612c8a61fbeaf
    ...
    public void onContinueButtonClick() {
        getStrings();
        Intent i = new Intent(TorsoPage.this, MainActivity.class);
        startActivity(i);
